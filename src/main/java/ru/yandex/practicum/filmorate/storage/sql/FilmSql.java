...
public final class FilmSql {
    ...
    public static final String FIND_FILM_SQL =
            BASE_FILM_SELECT +
                    " WHERE f.film_id = ?;";

    public static final String FIND_ALL_FILMS_SQL =
            BASE_FILM_SELECT +
                    " ORDER BY f.film_id;";
    ...
    // Новые константы для работы с лайками:
    /** Вставить лайк (film_id, user_id) */
    public static final String ADD_LIKE_SQL =
            "INSERT INTO film_likes (film_id, user_id) VALUES (?, ?)";

    /** Удалить лайк по film_id и user_id */
    public static final String DELETE_LIKE_SQL =
